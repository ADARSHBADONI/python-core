...
# s1=student("adarsh",99) #adding new student in Database..
# print(s1.name,s1.marks) #adarsh
...
# s1=student("adarsh") #adding new student in Database..
# print(s1.name) #adarsh as obj precidence>>> class atrr precidence
